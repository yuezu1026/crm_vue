<template>
  <v-table is-vertical-resize="" style="width:100%" is-horizontal-resize :vertical-resize-offset="5" :min-height="200" :columns="columns" :table-data="tableData" row-hover-color="#eee" row-click-color="#edf7ff"></v-table>
</template>
